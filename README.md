...
- **rds.yaml**
  - Provisions a single-AZ MySQL RDS instance (db.t3.micro, 7-day backup retention)
  - Master password is generated by RDS and stored in AWS Secrets Manager (no password in code)
